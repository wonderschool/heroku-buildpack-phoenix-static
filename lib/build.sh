...
# Taken from another fork of this buildpack at
# https://github.com/gigalixir/gigalixir-buildpack-phoenix-static/commit/414e2fcabf0ac28ee5d63d588feff4afa6517ea2
resolve_node() {
  ...
  echo "Checking index at $lookup_url..."
